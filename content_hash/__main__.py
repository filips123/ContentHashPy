...
from . import decode, encode, get_codec
...
def main():
    ...
    get_codec_parser = subparsers.add_parser(name="get-codec", help="extract the codec of a content hash")
    ...
    get_codec_parser = subparsers.add_parser(name="decode", help="decode a content hash")
    get_codec_parser.set_defaults(which="decode")
    get_codec_parser.add_argument("chash", help="an hex string containing a content hash")

    get_codec_parser = subparsers.add_parser(name="encode", help="encode a content hash")
